...
for row in df.itertuples():
    ...
    p.click()
    p.typewrite(row[1]  , interval=0.0000001)
    ...
    p.click()
    p.typewrite(row[2]  , interval=0.0000001)
    ...
    p.click()
    p.typewrite(row[3]  , interval=0.0000001)
    ...
    p.click()
    p.typewrite(row[4]  , interval=0.0000001)
    ...
    p.click()
    p.typewrite(str(row[7])  , interval=0.0000001)
